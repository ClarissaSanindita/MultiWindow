package com.example.user.multiwindowclarissa;
...
public class Main2Activity extends AppCompatActivity {
    TextView txtNama,txtTahun,txtAlamat,txtTelepon,txtEmail; String get_nama, get_alamat, get_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTelepon.setText("Nomor Tlp Anda "+get_telepon);
